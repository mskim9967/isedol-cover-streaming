              ...
              return (
                <>
                  ...
                  >
                    ...
                    >
                      <div
                        style={{ color: color.textBlack, padding: '25px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 18 }}
                      >
                          ...
                          {isLoading ? (
                            ...
                            <Button
                              ...
                              onClick={async () => {
                                ...
                                while (name !== null) {
                                  name = prompt(
                                    { kor: '새 플레이리스트 이름', jpn: 'プレイリス新しいプレイリストの名前', eng: "New playlist's name" }[lang]
                                  );
                                  if (name !== null) {
                                    name = name.trim();
                                    if (!name || name.length === 0)
                                      ...
                                      alert({ kor: '이름이 너무 깁니다', jpn: '名前があいています', eng: 'The name is empty' }[lang]);
                    ...
                    >
                      <div
                        style={{ color: color.textBlack, padding: '25px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 20 }}
                      >
